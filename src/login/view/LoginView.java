...
public class LoginView extends JFrame {
	...
	public LoginView() {
		...
		JLabel lblNewLabel_2 = new JLabel("<html><div style='text-align: center;'>HỆ THỐNG QUẢN LÝ<br>CỬA HÀNG KINH DOANH TRÀ SỮA</div></html");
		...
		textField_username.setBorder(new TitledBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(139, 69, 19)), "User name", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(139, 69, 19)));
		...
		textField_password.setBorder(new TitledBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(139, 69, 19)), "Password", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(139, 69, 19)));
