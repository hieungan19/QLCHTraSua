...
public class BillPageView extends JPanel{
	...
	public BillPageView() {
		...
		gbl_panel_1.columnWeights = new double[]{0.0, Double.MIN_VALUE, 0.0};
		...
		gbc_searchBar.insets = new Insets(0, 20, 5, 20);
		...
		btnAddBill.setPreferredSize(new Dimension(100, 40));
		GridBagConstraints gbc_btnAddBill = new GridBagConstraints();
		gbc_btnAddBill.insets = new Insets(0, 0, 5, 0);
		gbc_btnAddBill.gridx = 2;
		gbc_btnAddBill.gridy = 0;
		panel_1.add(btnAddBill, gbc_btnAddBill);
