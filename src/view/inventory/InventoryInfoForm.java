...
public class InventoryInfoForm extends JPanel {
	public InventoryInfoForm() {
		...
		gbl_panel_form.rowHeights = new int[]{445, 0};
		gbl_panel_form.columnWeights = new double[]{0.0, 0.0};
		gbl_panel_form.rowWeights = new double[]{0.0, Double.MIN_VALUE};
		...
		gbc_panel_imagePicker.insets = new Insets(0, 0, 0, 5);
		...
		gbl_panel_imagePicker.rowHeights = new int[] {0, 192, 0};
		...
		AppLabel lblNewLabel_2 = new AppLabel("MÃ MẶT HÀNG: ",16,true);
		GridBagConstraints gbc_lblNewLabel_2 = new GridBagConstraints();
		gbc_lblNewLabel_2.insets = new Insets(0, 0, 5, 0);
		gbc_lblNewLabel_2.gridx = 0;
		gbc_lblNewLabel_2.gridy = 0;
		panel_imagePicker.add(lblNewLabel_2, gbc_lblNewLabel_2);
		...
		panel_2.setLayout(new GridLayout(6, 0, 0, 20));
